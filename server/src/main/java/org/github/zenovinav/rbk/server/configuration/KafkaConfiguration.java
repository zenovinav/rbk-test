package org.github.zenovinav.rbk.server.configuration;
...
public class KafkaConfiguration {
    ...
    @Bean
    public ProducerFactory<String, ResultMessage> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, ResultMessage> kafkaTemplate() {
    ...
    public ConsumerFactory<String, TransactionMessage> consumerFactory() {
        ...
        var deserializer = new JsonDeserializer<TransactionMessage>();
